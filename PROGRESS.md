...
**Completion: 45.00%** — computed by `python scripts/completion.py`, never written by hand.
...
| Canvas with FDC3 | 0.80 | no surface renders a canvas yet — no CNVS command, both clients still show one screen at a time |
