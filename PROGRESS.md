...
**Completion: 23.76%** — computed by `python scripts/completion.py`, never written by hand.
...
> TQL grammar; WP6 1.0 with bulk XBRL), 23.47% (WP9 0.8 — planner and executor), **23.76%** (WP9 0.95 — overrides reach the models).
